...
Status: **current as of M0 and M1 complete; M2-M6 in progress, and the review-driven fixes R1-R5 done** (2026-09-19). Milestones sequence the work described in
...
| R8 | Wire `ExplainerInfoButton` (`:core:designsystem`, built with L1/L3) into the month grid's nominal-weekday header row and its intercalary band — the component and both call sites are specified in [ARCHITECTURE.md](ARCHITECTURE.md) §4. Without this, FEATURES L3 is only half done | ⬜ |
